...
let starWarsApiService = {
    ...
    getPeople: function (page) {
        ...
        if (navigationService.ajaxCallsCount[0] < 10) {
            ...
            alert("YOU HAVE REACHED DAILY LIMIT");
        }
    },
...
let uiService = {
    ...
    loadError: function(){
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="src/img/error.gif" alt="Error happened" class="center small">
            </div>
            <div class="col-md-3"></div>
        </div>
        <div class="row yellow padding">
            <div class="col-md-3"></div>
            <div class="col-md-6 yellow padding" >THE SHEEP IS CRUSHED, PLEASE TRY AGAIN LATER ...</div>
            <div class="col-md-3"></div>
        </div>
        `;
    },
