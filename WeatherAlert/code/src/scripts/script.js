let navService = {
    ...
    sortingResults: function () {
        function compareName(a, b) {
            const description1 = a.description.toUpperCase();
            const description2 = b.description.toUpperCase();
        ...
        for (let reading of data.list) {
            this.tableResult.innerHTML += `
                <div class="row">
                    ...
                    <div class="col-md-2 descriptionSort" onclick="navService.sortingResults()">${reading.weather[0].description}</div>
